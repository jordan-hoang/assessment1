...
void ResultFileIO::writeToTextFile(const std::vector<InspectionRegion>& records, const std::string& filename
) {
...
nlohmann::json ResultFileIO::readJsonFile(const std::string &queryFilePath) {
